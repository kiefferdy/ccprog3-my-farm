/**
 * This class represents the rank of the player
 */
public class Rank {
    private String name;
    ...
    /**
     * This constructor shows the details of a rank
    ...
    /**
     * This method gets the level needed for the player to reach the rank
     * @return the level requirement of the player to reach the rank
     */
    public int getLevelRequirements() {
     ...
     /**
     * This method gets the bonus earnings that the player will get when reaching the rank
     * @return the bonus earnings the player will get when reaching the rank
     */
    ...
    /**
     * This method gets the cost reduction that the player will get when reaching the rank
     * @return the cost reduction the player will get when reaching the rank
     */
    public int getCostReduction() {
     ...
     /**
     * This method gets the bonus water limit that the player will get when reaching the rank
     * @return the bonus water limit the player will get when reaching the rank
     */
    ...
    /**
     * This method gets the bonus fertilizer limit that the player will get when reaching the rank
    ...
    /**
     * This method gets the registration fee the player needs to get the rank
     * @return the registration fee the player needs to get the rank
     */
